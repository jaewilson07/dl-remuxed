# RouteContext Migration – DomoApplication/Job_RemoteDomoStats

## Status
- [ ] PR created
- [ ] All methods migrated (0/2)
- [ ] Tests updated/verified

## Methods to Update

- [ ] `DomoJob_RemoteDomoStats.get_by_id` (line 97)
...
- [ ] `DomoJob_RemoteDomoStats.create` (line 133)
  - Use `self._build_route_context(...)` to create context
  - Pass `context` to route functions
  - Remove manual `session`/`debug_api` pass-through
