...
# %% auto 0
__all__ = ['DomoBase', 'DomoEntity', 'DomoEntity_w_Lineage', 'DomoFederatedEntity', 'DomoPublishedEntity', 'DomoManager',
           'DomoSubEntity', 'Entity_Relation']
...
from domolibrary.utils.convert import convert_snake_to_pascal
import abc
...
# %% ../../nbs/client/99_DomoEntity.ipynb 7
class DomoEnum( Enum):
...
# %% ../../nbs/client/99_DomoEntity.ipynb 13
@dataclass
...
# %% ../../nbs/client/99_DomoEntity.ipynb 14
@dataclass
class DomoFederatedEntity(DomoEntity_w_Lineage):
    
    @abc.abstractmethod
    async def get_federated_parent(self, parent_auth = None, parent_auth_retrieval_fn : Callable = None):
        raise NotImplementedError("This method should be implemented by subclasses.")
...
class DomoPublishedEntity(DomoFederatedEntity):
    ...
    @abc.abstractmethod
    async def get_parent_publication(self, parent_auth = None,parent_auth_retreival_fn = None):
...
# %% ../../nbs/client/99_DomoEntity.ipynb 15
@dataclass
...
# %% ../../nbs/client/99_DomoEntity.ipynb 16
@dataclass
