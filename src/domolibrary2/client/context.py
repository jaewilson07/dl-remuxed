...
This module provides the RouteContext class for encapsulating common parameters
used in route function calls, enabling cleaner function signatures and easier
parameter management.

Classes:
    RouteContext: Container for common route function parameters
"""
...
class RouteContext:
    ...
    reducing parameter duplication and enabling easier parameter management.
    ...
    def to_dict(self) -> dict:
        ...
        Returns:
            Dictionary containing context parameters suitable for get_data calls
        """
        return {
