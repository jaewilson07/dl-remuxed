# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/classes/50_DomoInstanceConfig_Scheduler_Policies.ipynb.

# %% auto 0
__all__ = ['parse_dt', 'DomoScheduler_Policy_Restrictions', 'DomoScheduler_Policy_Frequencies', 'DomoScheduler_Policy_Member',
           'DomoScheduler_Policy', 'DomoScheduler_Policies']

# %% ../../nbs/classes/50_DomoInstanceConfig_Scheduler_Policies.ipynb 2
from typing import Literal, Optional
from datetime import datetime

from domolibrary.client.DomoEntity import  DomoEnum, DomoBase, DomoSubEntity
import domolibrary.client.DomoAuth as dmda

import domolibrary.routes.instance_config_scheduler_policies as scheduler_policies_routes
...
# %% ../../nbs/classes/50_DomoInstanceConfig_Scheduler_Policies.ipynb 6
...
class DomoScheduler_Policy(DomoBase):
    ...
    id: Optional[str] = field(default=None) # Will be None if the policy is not yet created (used on upsert)
...
# %% ../../nbs/classes/50_DomoInstanceConfig_Scheduler_Policies.ipynb 8
@dataclass
