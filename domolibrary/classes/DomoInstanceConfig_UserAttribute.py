...
from domolibrary.client.DomoEntity import DomoEntity, DomoManager
...
# %% ../../nbs/classes/50_DomoInstanceConfig_UserAttributes.ipynb 8
...
# %% ../../nbs/classes/50_DomoInstanceConfig_UserAttributes.ipynb 11
@dataclass
...
# %% ../../nbs/classes/50_DomoInstanceConfig_UserAttributes.ipynb 18
@patch_to(UserAttributes)
async def delete(
    self: UserAttributes,
    attribute_id: str,
