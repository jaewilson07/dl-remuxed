...
class DomoError(Exception):
    ...
    def __init__(
        ...
        if parent_class and not function_name:
            function_str = (
                f"{res and res.traceback_details.parent_class or parent_class} || "
            )
        ...
        **kwargs,
        ...
        err = {
            ...
            "function_name": (
                ...
                if res and res.traceback_details
                else None
            ),
            ...
            "parent_class": (
                res.traceback_details.parent_class
                if res and res.traceback_details
                else None
            ),
...
class ClassError(DomoError):
    ...
    def __init__(
        ...
        entity_name = (
            entity_name
            or (cls_instance and cls_name_attr and getattr(cls_instance, cls_name_attr))
            or ""
        )
