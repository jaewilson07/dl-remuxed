...
Functions:
    ...
    test_valid_email: Validate email format
...
Example:
    ...
    >>> # Email validation
    >>> try:
    ...     test_valid_email("user@example.com")  # Returns True
    ... except InvalidEmail:
    ...     print("Invalid email")
"""
...
from .exceptions import InvalidEmailError, ConcatDataframeError
...
def convert_python_to_ast_module(
    ...
    if not python_str and python_file_path:
        try:
            with open(python_file_path, "r", encoding="utf-8") as source:
...
def test_valid_email(email: str) -> bool:
    """
    ...
    Example:
        ...
        True
        >>> test_valid_email("invalid-email")
