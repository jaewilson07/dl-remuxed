...
<<<<<<<< HEAD:src/classes/DomoMembership.py
...
>>>>>>>> test:src/domolibrary2/classes/subentity/DomoMembership.py
...
>>>>>>>> test:src/domolibrary2/classes/subentity/DomoMembership.py
    ...
    async def _extract_domo_entities_from_list(
        ...
        return [
            Membership_Entity(
                entity=entity, relation_type=relation_type, auth=entity.auth
            )
...
async def set_members(
    ...
    user_ls = [
        Membership_Entity(entity=user, relation_type="MEMBER", auth=self.auth)
        for user in user_ls
    ]
...
>>>>>>>> test:src/domolibrary2/classes/subentity/DomoMembership.py
    ...
    owner_ls = [
        Membership_Entity(entity=owner, relation_type="OWNER", auth=self.auth)
