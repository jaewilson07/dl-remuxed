# RouteContext Migration – instance_config/allowlist
...
- [ ] `get_allowlist` (line 40)
  - Add `context: RouteContext | None = None` (keyword-only)
  - Normalize context inside function
  - Call `get_data(..., context=context)`
- [ ] `set_allowlist` (line 79)
  - Add `context: RouteContext | None = None` (keyword-only)
  - Normalize context inside function
  - Call `get_data(..., context=context)`
- [ ] `get_allowlist_is_filter_all_traffic_enabled` (line 116)
  - Add `context: RouteContext | None = None` (keyword-only)
  - Normalize context inside function
  - Call `get_data(..., context=context)`
- [ ] `toggle_allowlist_is_filter_all_traffic_enabled` (line 164)
  - Add `context: RouteContext | None = None` (keyword-only)
  - Normalize context inside function
  - Call `get_data(..., context=context)`
