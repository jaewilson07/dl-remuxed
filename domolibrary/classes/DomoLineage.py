...
from aenum import Enum as DomoEnum, NoAlias 
...
from domolibrary.client.DomoEntity import  DomoEntity, DomoFederatedEntity
...
class DomoLineage:
    ...
    async def _get_federated_lineage(
        ...
        parent_entity = await self.parent.get_federated_parent(parent_auth=parent_auth, parent_auth_retrieval_fn=parent_auth_retreival_fn   )
...
# %% ../../nbs/classes/50_DomoLineage.ipynb 14
@dataclass
...
# %% ../../nbs/classes/50_DomoLineage.ipynb 17
@dataclass
