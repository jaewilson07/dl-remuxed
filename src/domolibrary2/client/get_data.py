...
async def get_data(
    ...
    If context is provided, its values take precedence over individually provided parameters.
    """
    ...
    if context is not None:
        ...
        debug_num_stacks_to_drop = context.debug_num_stacks_to_drop  # noqa: F841
        parent_class = (
