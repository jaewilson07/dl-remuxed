...
def generate_search_datacenter_body(
    ...
    entity_type = [en.value if isinstance(en, Datacenter_Enum) else en for en in entity_type]
...
async def share_resource(
    ...
    resource_ls = [{"type": resource_type.value, "id": str(rid)} for rid in resource_ids]
