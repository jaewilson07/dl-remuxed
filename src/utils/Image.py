...
def handle_string_to_bytes_and_decode(data: Union[str, bytes]) -> bytes:
    """
...
def handle_string_to_bytes_and_encode(data: Union[str, bytes]) -> bytes:
    """
...
def are_same_image(image1, image2) -> bool:
    ...
    try:
        ...
        raise ImageProcessingError(f"compare images", str(e))
