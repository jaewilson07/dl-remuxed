...
async def get_integration_warehouses(
    ...
    if res.status == 403:
        raise Cloud_Amplifier_Error(res=res, message=f"User may not have permission to view the warehouses - {integration_id}")
...
# %% ../../nbs/routes/cloud_amplifier.ipynb 16
@gd.route_function
...
# %% ../../nbs/routes/cloud_amplifier.ipynb 21
@gd.route_function
...
# %% ../../nbs/routes/cloud_amplifier.ipynb 26
@gd.route_function
...
# %% ../../nbs/routes/cloud_amplifier.ipynb 30
@gd.route_function
