...
def test_stream_from_dict_with_account():
    ...
    stream_obj = {
        ...
        "account": {"id": "456", "displayName": "Test Account", "userId": "user-789"},
...
def test_stream_to_dict_excludes_account():
    ...
    stream_obj = {
        ...
        "account": {"id": "789", "displayName": "MySQL Account", "userId": "user-999"},
        "updateMethod": "APPEND",
        "configuration": [],
    }
    ...
    assert (
        "Account" not in stream_dict
    ), "Account object should not be in to_dict output"
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "  ✅ from_dict() populates account_id, account_display_name, account_userid"
        )
        ...
        print(
            "  ✅ get_by_id() can retrieve and set Account (via is_get_account parameter)"
        )
