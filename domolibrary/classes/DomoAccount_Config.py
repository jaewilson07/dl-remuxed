...
class DomoAccount_Config_DatasetCopy(DomoAccount_Config):
    ...
    def to_dict(self):
        return super().to_dict({"accessToken": self.access_token, "instance": self.domo_instance})
...
class DomoAccount_Config_Governance(DomoAccount_Config):
    ...
    def to_dict(self):
        return super().to_dict({"apikey": self.access_token, "customer": self.domo_instance})
